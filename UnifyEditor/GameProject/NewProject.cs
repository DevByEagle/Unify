...
namespace UnifyEditor.GameProject
{
  ...
  class NewProject : ViewModelBase
  {
    ...
    private string _projectPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}\UnifyProjects\";
    ...
    public string CreateProject(ProjectTemplate template)
    {
      ...
      try
      {
        ...
        var projectPath = Path.GetFullPath(Path.Combine(path, $"{ProjectName}{Project.Extonsion}"));
